              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <select name="menu_id[]" class="form-control form-control-sm select2" id="menu_id" multiple="multiple">
                    ...
                    <option value="{{$module->id}}" {{(request()->menu_id)?((in_array($module->id, request()->menu_id))?("selected"):""):''}}>{{(app()->getLocale() == 'bn')?($module->name_bn):$module->name}} ( {{(app()->getLocale() == 'bn')?($module['module']['name_bn']):$module['module']['name']}} )</option>                 
                    @endforeach
                  </select>
                </div>           
                <div class="col-sm-3">              
