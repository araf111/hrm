...
<div class="content-header">  
	<div class="container-fluid">  
		<div class="row mb-2">  
			<div class="col-sm-6">  
				<h4 class="m-0 text-dark">@lang('Menu Management')</h4>  
			</div>  
			<div class="col-sm-6">  
				<ol class="breadcrumb float-sm-right">  
					<li class="breadcrumb-item"><a href="#">@lang('Home')</a></li>  
					<li class="breadcrumb-item active">@lang('Menu Management')</li>  
				</ol>  
			</div>  
		</div>  
	</div>  
			...
			<div class="col-lg-12">  
				<div class="card">  
					<div class="card-header text-right">  
						<a href="{{route('admin.menu-management.menu-info.list')}}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> @lang('Menu List')</a>  
					</div>  
					<div class="card-body">  
						<form id="submitForm">  
							@csrf  
							<div class="row">  
								<div class="col-sm-4">  
									<div class="form-group">  
										...
										<input type="text" name="name" value="{{@$editData->name}}" class="form-control form-control-sm name" placeholder="@lang('Enter Menu Name in English')" >                 
									</div>  
								</div>  
								<div class="col-sm-4">  
									<div class="form-group">  
										<label class="control-label">@lang('Menu Name') <small>(@lang('Bangla'))</small></label>  
										<input type="text" name="name_bn" value="{{@$editData->name_bn}}" class="form-control form-control-sm name_bn" placeholder="@lang('Enter Menu Name in Bangla')" >                 
									</div>  
								</div>
								<div class="col-sm-4">  
									<div class="form-group {{$errors->has('module_id') ? 'has-error' : ''}}">   
										...
										<select name="module_id" class="form-control form-control-sm select2 module_id">
											<option value="">@lang('Seelct Module Name')</option>
								...
								<div class="col-sm-4">  
									<div class="form-group">  
										...
										<input type="text" name="url" value="{{@$editData->route}}" class="form-control form-control-sm url" placeholder="@lang('Enter Route Name')">  
									</div>  
								</div>  
								<div class="col-sm-3">  
									<div class="form-group">  
								...
								<div class="col-sm-3">  
									<div class="form-group">  
										...
										<input type="number"  value="{{@$editData->sort}}" name="sort" class="form-control form-control-sm sort" placeholder="@lang('Enter Sort Number')">  
									</div>  
								</div>  
								<div class="col-sm-3">  
									<div class="form-group">  
										<label class="control-label">@lang('Icon')</label>    
										<input data-toggle="modal" data-target="#iconListModal" data-backdrop="static" data-keyboard="false" type="text" name="icon" id="icon" value="{{@$editData->icon}}" class="form-control form-control-sm icon" placeholder="@lang('Enter Icon Name')" readonly="readonly">  
									</div>  
								</div>  
								<div class="col-sm-3">  
									<div class="form-group">  
										<label class="control-label">@lang('If Exist Extra Route')</label>    
										<button type="button" class="btn btn-sm btn-default btn-block addextraRoute">@lang('Add More Route')</button>  
									</div>  
								</div>  
							</div>  
								...
								<div class="remove_extraRouteDiv card card-body" style="background: #e9e9e9;">                 
									<div class="row">  
										<div class="col-sm-2">  
											<div class="form-group">  
												<label class="control-label">@lang('Menu Name') <small>(@lang('English'))</small></label>  
												<input type="text" id="newname[{{$val->id}}]" name="newname[{{$val->id}}]" value="{{$val->name}}" class="newname form-control form-control-sm" placeholder="@lang('Enter Menu Name in English')" >                 
											</div>  
										</div>  
										<div class="col-sm-2">  
											<div class="form-group">  
										...
										<div class="col-sm-3">  
											<div class="form-group">  
												...
												<input type="text" id="newurl[{{$val->id}}]" name="newurl[{{$val->id}}]" value="{{$val->route}}" class="newurl form-control form-control-sm" placeholder="@lang('Enter Route Name')">  
											</div>  
										</div>  
										<div class="col-sm-2">  
											<div class="form-group">  
												<label class="control-label">@lang('Sort Order')</label>  
												<input type="number" id="newsort[{{$val->id}}]" name="newsort[{{$val->id}}]" value="{{$val->sort}}" class="newsort form-control form-control-sm" placeholder="@lang('Enter Sort Number')">  
											</div>  
										</div>  
