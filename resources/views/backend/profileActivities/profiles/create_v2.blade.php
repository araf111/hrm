                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <select name="empId" id="empId" class='form-control select2'>
                                                    ...
                                                    @foreach ($profileID_list as $list)
                                                        <option value="{{ $list }}" @if (isset($editData) && $editData->profileID == $list) {{ 'selected' }} @endif>
                                                            {{ digitDatelang($list) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6 mt-4">
                                                <button type="button" name="load_profile"
                                                    ...
                                                    onclick="load_data('employee_id')"> @lang('Search') </button>
                                                <button type="button" name="load_profile"
                                                    class="btn btn-secondary btn-sm mt-1 d-none"
                                                    onclick="test_data('employee_id')"> @lang('TEST Search') </button>
                                                <button type="button" name="load_profile"
                                                    class="btn btn-secondary btn-sm mt-1 d-none"
                                                    onclick="sms_test()"> @lang('TEST SMS') </button>
                                                <button type="button" name="load_profile"
                                                    class="btn btn-secondary btn-sm mt-1 d-none"
                                                    onclick="profile_image_conversion('employee_id')"> @lang('Convert Image') </button>
                                            ...
                                            <div class="form-row mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                                                    {{-- <input id="dateOfBirth"
                                                        ...
                                                        value="{{ 
                                                            (isset($editData->dateOfBirth) && $editData->dateOfBirth!='' && $editData->dateOfBirth!='0000-00-00')?nanoDateFormat($editData->dateOfBirth):'' }}"
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                                                    {{-- <input id="passportIssueDate" 
                                                        ...
                                                        value="{{ 
                                                            (isset($editData->passportIssueDate) && $editData->passportIssueDate!='' && $editData->passportIssueDate!='0000-00-00')?nanoDateFormat($editData->passportIssueDate):'' }}"
                                                        autocomplete="off"
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                                                    {{-- <input id="passportExpireDate"
                                                        ...
                                                        value="{{ 
                                                            (isset($editData->passportExpireDate) && $editData->passportExpireDate!='' && $editData->passportExpireDate!='0000-00-00')?nanoDateFormat($editData->passportExpireDate):'' }}"
                                                        autocomplete="off"
...
@section('script')
    ...
    <script>
                ...
                success: function(response) {
                    ...
                    if (response.responseCode == 200) {
                        if (type == 'employee_id') {
                            ...
                            //console.log(parseInt(parseInt(basicInfo.religion)-1));
                            if(parseInt(parseInt(basicInfo.religion))==2){
                                basicInfo.religion = 1;
                            }
                            else if(parseInt(parseInt(basicInfo.religion))==3){
                                basicInfo.religion = 2;
                            }
                            else if(parseInt(parseInt(basicInfo.religion))==4){
                                basicInfo.religion = 3;
                            }
                            else if(parseInt(parseInt(basicInfo.religion))==5){
                                basicInfo.religion = 4;
                            }
                            else if(parseInt(parseInt(basicInfo.religion))==6){
                                basicInfo.religion = 5;
                            }
                            else{
                        ...
                        Swal.fire('{{Lang::get("No Data Found")}}', '', 'error');
                        my_loader('stop');
                    }
                },
                error: function(res) {
        ...
        function test_data(type) {
            ...
            $.ajax({
                url: "{{ url('/profile-activities/loadAllprofiles') }}",
                type: "POST",
                data: request_data,
                success: function(response) {
                    my_loader('stop');
        ...
        function sms_test() {
            my_loader('start');
               request_data = {
                    _token: "{{ csrf_token() }}",
                    mobile_no: '8801511132053',
                    sms_body: 'Hello from MP portal SMS service'
                };
        ...
        function profile_image_conversion(type) {
            my_loader('start');
            if (type == 'employee_id') {
                request_data = {
                    _token: "{{ csrf_token() }}",
            ...
            $.ajax({
                url: "{{ url('/profile-activities/profileImage') }}",
                type: "POST",
                data: request_data,
                success: function(response) {
                    my_loader('stop');
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $('#profile_form').submit(function(e) {
                ...
                formData.append('profileID', $("#empId").val());
                var request_url;
                @php if(isset($editData)){ @endphp 
                    request_url = "{{ url('profile-activities/updateprofile') }}";
                @php  } else{ @endphp
                    request_url = "{{ url('profile-activities/storeProfile') }}";
                @php } @endphp
                           ...
                           var all_message = "";
                            if(data.message.length>0){
                                for(var i=0; i<data.message.length; i++){
                                    all_message+=' <br> '+data.message[i];
                                }
                            }
                            Swal.fire(all_message, '', 'error');
                            my_loader('stop');
                        }
                    },
                    error: function(data) {
