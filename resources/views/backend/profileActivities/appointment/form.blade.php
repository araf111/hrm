        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="parliamentForm" name="parliamentForm" method="POST"
                      @if($data->id)
                      action="{{ route('admin.profile-activities.appointments.update', $data->id) }}">
                    <input name="_method" type="hidden" value="PUT">
                    @else
                        action="{{ route('admin.profile-activities.appointments.store') }}">
                    @endif
                    @csrf
                            ...
                            <div class="col-sm-12">
                                <div class="form-group text-right">
                                    <button type="button" class="btn btn-default btn-sm ion-android-arrow-back">
                                        <a href="{{route('admin.profile-activities.appointments.index') }}">@lang('Back')</a>
                                    </button>
                                    @if($data->id)
