                ...
                <form method="POST" action="{{ isset($editData) ? route('admin.profile-activities.file-info.update',$editData->id) : route('admin.profile-activities.file-info.store') }}"  enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-4">
                            <label for="" class="control-label">@lang('Category')</label>
                            <select name="file_category_id" id="file_category_id" class="form-control form-control-sm select2 @error('file_category_id') is-invalid @enderror">
                        ...
                        <div class="form-group col-sm-4">
                            <label for="" class="control-label">@lang('Name Of File')</label>
                            <input type="text"  required name="file_name" value="{{ $editData->file_name ?? old('file_name') }}" class="form-control form-control-sm @error('file_name') is-invalid @enderror" placeholder="">
                            @error('file_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            <label for="" class="attachment-label">@lang('File Attachment')</label>
                            <div class="file p-0">
                                <input type="file" class="form-control attachment_upload pl-1" name="attachment" id="attachment" accept=".png, .jpg, .jpeg, .pdf">
                            </div>
                        </div>
