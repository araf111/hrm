                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select id="designition_id" name="designition_id[]" class="form-control designition_id @error('designition_id') is-invalid @enderror select2" multiple>
                                    <option value="">@lang('Select Designation')</option>
                                    @foreach ($designation as $list)
                                        @if($data->id && in_array($list->id,json_decode($data->designition_id)))
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="telphone_expenses" name="telphone_expenses" value="{{old('telphone_expenses', $data->telphone_expenses)}}" class="form-control telphone_expenses @error('telphone_expenses') is-invalid @enderror" placeholder="@lang('Enter Monthly Telephone Expenses Including Internet (Taka)')" autocomplete="off" maxlength="30">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="cashing_allowance" name="cashing_allowance" value="{{old('cashing_allowance', $data->cashing_allowance)}}" class="form-control cashing_allowance @error('cashing_allowance') is-invalid @enderror" placeholder="@lang('Enter Monthly Telephone Cashing Allowance with Internet (Taka)')" autocomplete="off" maxlength="30">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group text-right">
                            ...
                            <button type="button" class="btn btn-default btn-sm ion-android-arrow-back">
                                <a href="{{route('admin.requisition.telephoneExpensesCashAllowance.index') }}">@lang('Back')</a>
                            </button>
                        </div>
                    </div>
                </div>
