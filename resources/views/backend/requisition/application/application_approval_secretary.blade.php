                                                    ...
                                                    @if (isset($applyData) && count($applyData) > 0)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('admin.requisition.application-approval-secretary-action',$data->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-paper-plane" aria-hidden="true"></i> @lang('Approval')</i></a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    @endif
                                            ...
                                            <table class="table table-bordered table-striped" id="dataTable" style="font-size:12px !important">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>@lang('Approved by Admin Date')</th>
                                                        <th>@lang('Approved by Deputy Secretary Date')</th>
                                                        <th>@lang('Approved by Secretary Date')</th>
                                                        {{-- <th>@lang('Action')</th> --}}
                                                    </tr>
                                                </thead>
                                                <tbody>
...
@endsection
    ...
    <script>
        function getData(object, id){
            ...
            $.ajax({
                type : "GET",
                url : "{{route('admin.mp-id-card-application.application-approaval-modal')}}",
                data : {id : app_id},
