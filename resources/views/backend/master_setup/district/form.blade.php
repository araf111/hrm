                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" for="division_id">@lang('Division')<span
                                            style="color: red;"> *</span></label>
                                    <select id="division_id" name="division_id" class="form-control @error('division_id') is-invalid @enderror select2">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lon" name="lon" value="{{old('lon', $data->lon)}}"
                                           class="form-control form-control-sm @error('lon') is-invalid @enderror"
