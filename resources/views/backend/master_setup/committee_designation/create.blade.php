        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>@lang('Add Committee Designation')</h5>
                    ...
                    <form id="createForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-3 col-lg-3">
                                ...
                                <input id="name_bn" type="text" name="name_bn" placeholder="@lang('Enter Designation')" class='name_bn form-control form-control-sm'>        
                            </div>
                                ...
                                <input id="name_en" type="text" name="name_en" placeholder="@lang('Enter Designation')" class='name_en form-control form-control-sm' required>
                            </div>
    ...
    $(document).ready(function(){
        $('#createForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url : "{{route('admin.master_setup.committee_designation.store')}}",
                    data : formInfo,
                    type : "POST",
                    processData: false,
                    contentType: false,
