                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bn_name" name="bn_name" value="{{old('bn_name', $data->bn_name)}}"
                                           class="form-control bn_name form-control-sm @error('bn_name') is-invalid @enderror"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" value="{{old('name', $data->name)}}"
                                           class="form-control name form-control-sm @error('name') is-invalid @enderror"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lat" class="form-control form-control-sm" value="{{(isset($data) && $data)?$data->lat:''}}" placeholder="@lang('Enter Latitude')" />
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('Longitude')</label>
                                    <input type="text" name="lon" class="form-control form-control-sm" value="{{(isset($data) && $data)?$data->lon:''}}" placeholder="@lang('Enter Longitude')" />
                                </div>
                            </div>
