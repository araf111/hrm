                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name_eng" name="name_eng" value="{{old('name_eng', $data->name_eng)}}" class="form-control form-control-sm name_eng @error('name_eng') is-invalid @enderror" placeholder="@lang('Enter Name in English')" autocomplete="off">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name_bn" name="name_bn" value="{{old('name_bn', $data->name_bn)}}" class="form-control form-control-sm name_bn @error('name_bn') is-invalid @enderror" placeholder="@lang('Enter Name in Bangla')" autocomplete="off">
