    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- Form Start-->
                <form id="designationForm" method="POST" action="{{ isset($editData) ? route('admin.master_setup.designations.update', $editData->id) : route('admin.master_setup.designations.store') }}">
                    @csrf
                    @if (isset($editData))
                        @method('PUT')
                    @endif
