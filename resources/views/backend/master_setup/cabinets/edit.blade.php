                                    ...
                                    <div class="form-group row">
                                        <div class="col-3">
                                            <select name="minister_wing[]" class="@error('minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                <option value="{{ $data->id }}" @if(isset($m->wing_id) && $data->id==$m->wing_id) {{'selected="selected"'}} @endif >
                                        ...
                                        <div class="col-3">
                                            <select name="minister[]" class="@error('minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                <option value="{{ $data->user_id }}" @if( $data->user_id==$m->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="minister[]" class="@error('minister') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if(isset($m->profile_id) && $data->user_id==$m->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="state_minister[]" class="@error('state_minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if( $data->user_id==$state->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="state_minister[]" class="@error('state_minister') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select State Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if(isset($state->profile_id) && $data->user_id==$state->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="deputy_minister[]" id="deputy_minister" class="@error('deputy_minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if( $data->user_id==$deputy->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="deputy_minister[]" id="deputy_minister" class="@error('deputy_minister') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select Deputy Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if( isset($deputy->profile_id) && $data->user_id==$deputy->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="secretary[]" id="secretary" class="@error('secretary') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select State Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if( $data->user_id==$sec->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="joint secretary[]" id="joint secretary" class="@error('joint secretary') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->user_id }}" @if( $data->user_id==$joint_sec->profile_id) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
