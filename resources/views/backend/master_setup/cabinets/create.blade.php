                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="minister[]" id="minister" class="@error('minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                <option value="{{ $data->id }}" @if($data->id == old('minister')) {{'selected="selected"'}} @endif >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="state_minister[]" id="state_minister" class="@error('state_minister') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->id }}" @if($data->id == old('state_minister')) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <select name="deputy_minister[]" id="deputy_minister" class="@error('deputy_minister') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select State Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->id }}" @if($data->id == old('deputy_minister')) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            <select name="secretary[]" id="secretary" class="@error('secretary') is-invalid @enderror form-control form-control-sm select2">
                                                <option value="">@lang('Select State Minister')</option>
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->id }}" @if($data->id == old('secretary')) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            <select name="joint secretary[]" id="joint secretary" class="@error('joint secretary') is-invalid @enderror form-control form-control-sm select2">
                                                ...
                                                @foreach ($profile_list as $data)
                                                <option value="{{ $data->id }}" @if($data->id == old('joint secretary')) {{'selected="selected"'}} @endif >
                                                    @if(session()->get('language') == 'bn')
                                                    {{ $data->nameBng }}
                                                    @else 
                                                    {{ $data->nameEng }}
