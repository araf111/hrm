...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">@lang('Password Management')</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">@lang('Home')</a></li>
                    <li class="breadcrumb-item active">@lang('Password Management')</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('profile-management.store.password') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-6">
                                    <label>@lang('Confirm Password') <span
                                        style="color: red">*</span></label>
                            ...
                            <button class="btn bg-gradient-success btn-flat"><i class="fas fa-save"></i> 
                                {{ !empty($editData)? __('Update') : __('Save') }}
                            </button>
                        </form>
                    </div>
                    <!-- /.card-body -->
