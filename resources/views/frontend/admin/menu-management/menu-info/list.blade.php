    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header text-right">
                <a id="demo-btn-addrow" class="btn btn-success btn-sm" href="{{route('admin.landing_page.menu-info.add')}}">
                    <i class="ion-plus"></i> @lang('Add Menu')
                </a>
            </div>
            <div class="card-body">
                <form action="{{route('admin.landing_page.menu-info.sorting')}}" method="post">
                    @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="nestable" style="width: 100%;">
                            <?php $parents = App\Model\Frontend\MenuFrontend::orderBy('sort', 'asc')->where('parent','0')->get();?>
                            @if(count($parents) != 0)
                            <ol class="dd-list new_data">
                                ...
                                <li class="dd-item" data-id="{{$parent->id}}">
                                    ...
                                    <span style="font-size: 20px;z-index:10;position:absolute; right:35px; top:4px; cursor:pointer;">
                                        <a href="{{route('admin.landing_page.menu-info.edit',$parent->id)}}">
                                    ...
                                    <?php $parents = App\Model\Frontend\MenuFrontend::orderBy('sort','asc')->where('parent',$parent->id)->get();?>
                                    @if(count($parents) != 0)
                                    <ol class="dd-list">
                                        @foreach($parents as $parent)
                                        <li class="dd-item" data-id="{{$parent->id}}">
