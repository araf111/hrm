...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('Latest News Management')</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">@lang('Home')</a></li>
                        <li class="breadcrumb-item active">@lang('Latest News Management')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    @if (isset($editData))
                        <h5>@lang('Update Latest News')</h5>
                    @else
                        <h5>@lang('Create Latest News')</h5>
                    @endif
                </div>
                <!-- Form Start-->
                <form  id="submitForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="contentBng" id="contentBng" class="form-control contentBng @error('contentBng') is-invalid @enderror" placeholder="@lang('Enter Content in Bangla')">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="contentEng" id="contentEng" class="form-control contentEng @error('contentEng') is-invalid @enderror" placeholder="@lang('Enter Content in English')">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group text-right">
                                    <a href="{{route('admin.landing_page.latest_news.index') }}" class="btn btn-dark btn-sm ion-android-arrow-back text-white"> @lang('Back')</a>
                                    @if(@$editData->id)
        ...
        $(document).ready(function(){
            $('#submitForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url : "{{(@$editData)?route('admin.landing_page.latest_news.update',@$editData->id):route('admin.landing_page.latest_news.store') }}",
                        data : formInfo,
                        type : "POST",
                        processData: false,
                        contentType: false,
                        ...
                        success:function(data){
                            if(data.status == 'success'){
                                ...
                                $('.preload').hide();
                                setTimeout(function(){
                                   location.replace("{{route('admin.landing_page.latest_news.index')}}");
                               }, 1450);
