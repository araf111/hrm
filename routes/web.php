...
/*========== SSO stuff ================================== */
Route::get('/ssologin', 'SSOLoginController@ssologin');
//Route::post('/applogin', 'SSOLoginController@applogin');
Route::get('/ssologout', 'SSOLoginController@ssologout');
/* ========================================================== */

/* Notification Stuff */
Route::get('/test_sms', 'Backend\ProfileActivities\V2ProfileController@testSMS');
Route::post('/send_sms', 'Backend\NotificationController@sendSMS');
/* ======================== */
...
Route::post( '/citizenAppointmentInsert', 'Backend\AppointmentManagement\CitizenAppointment@citizenAppointmentInsert' )->name( 'citizenAppointmentInsert' );
...
Route::get( '/appointmentCheck', 'Backend\AppointmentManagement\CitizenAppointment@appointmentCheck' )->name( 'appointmentCheck' );
Route::get( '/checkOtp', 'Backend\AppointmentManagement\CitizenAppointment@checkOtp' )->name( 'checkOtp' );
Route::get( '/appointmentOtpView', 'Backend\AppointmentManagement\CitizenAppointment@appointmentOtpView' )->name( 'appointmentOtpView' );
Route::get( '/appointmentMonitoring', 'Backend\AppointmentManagement\CitizenAppointment@appointmentMonitoring' )->name( 'appointmentMonitoring' );
Route::get( '/appointmentMonitoringGetData', 'Backend\AppointmentManagement\CitizenAppointment@appointmentMonitoringGetData' )->name( 'appointmentMonitoringGetData' );
...
// Route::get( 'petitionSystem', 'Backend\PetitionManagement\PetitionController@petitionSystem' )->name( 'petitionSystem' );

Route::resource( '/petitions', 'Frontend\PetitionManagement\PetitionController' );
Route::get( '/petition/welcome', 'Frontend\PetitionManagement\PetitionController@petitionsWelcome' )->name( 'petitionsWelcome' );
Route::post( '/petitionInsert', 'Frontend\PetitionManagement\PetitionController@petitionInsert' )->name( 'petitionInsert' );
Route::post( '/petitionsContactInfo', 'Frontend\PetitionManagement\PetitionController@petitionsContactInfo' )->name( 'petitionsContactInfo' );
Route::get( '/petition/monitoring', 'Frontend\PetitionManagement\PetitionController@petitionsMonitoring' )->name( 'petitionsMonitoring' );
Route::get( '/petitionsMonitoringGetData', 'Frontend\PetitionManagement\PetitionController@petitionsMonitoringGetData' )->name( 'petitionsMonitoringGetData' );
Route::get( '/petitionOtpView', 'Frontend\PetitionManagement\PetitionController@petitionOtpView' )->name( 'petitionOtpView' );
Route::get( 'petitionSystem', 'Frontend\PetitionManagement\PetitionController@petitionSystem' )->name( 'petitionSystem' );
Route::get( '/petitionCheck', 'Frontend\PetitionManagement\PetitionController@petitionCheck' )->name( 'petitionCheck' );
...
Route::get( '/mpList', 'Frontend\PetitionManagement\PetitionController@mpListByDDU' )->name( 'mpListByDDU' );

// Citizen Question
Route::resource( '/citizen_questions', 'Frontend\CitizenQuestionController' );
Route::get( '/mp_list', 'Frontend\CitizenQuestionController@mpList' )->name( 'mpList' );
Route::get( '/all_question', 'Frontend\CitizenQuestionController@allQuestion' )->name( 'allQuestion' );
Route::get( '/all_answer', 'Frontend\CitizenQuestionController@allAnswer' )->name( 'allAnswer' );


Route::get( '/unionListByUpazila', 'Backend\MasterSetup\AjaxController@unionListByUpazila' )->name( 'unionListByUpazila' );
...
Route::middleware( ['auth'] )->group( function () {
    ...
    Route::get( '/dashboard_summary/{session?}/{module?}', 'Backend\HomeController@getSummary' )->name( 'dashboard_summary' );
    Route::get( '/dashboard_pdf/{session?}/{type?}', 'Backend\HomeController@generatePDF' )->name( 'dashboard_pdf' );

    Route::get( '/active-users', 'Backend\HomeController@activeUser' )->name( 'activeusers' );
    Route::get( '/get-active-users', 'Backend\HomeController@getActiveUser' )->name( 'get-active-users' );
    Route::get( '/get-login-activity', 'Backend\HomeController@getLoginActivity' );
    Route::post( '/user-log-details', 'Backend\HomeController@getLogDetails' );
    Route::get( '/getpoles/{id}', 'Backend\HomeController@getPoles' );
    Route::post( '/savepole', 'Backend\HomeController@savePole' );
    ...
    // Citizen Question Auth
    Route::group( ['prefix' => 'citizen-question', 'as' => 'citizen_question', 'namespace' => 'Frontend'], function () {
        Route::get( 'questions', 'CitizenQuestionController@questionList' );
        Route::get( 'questions/{id}', 'CitizenQuestionController@questionView' )->name('questionView');
        Route::post( 'questions/answer', 'CitizenQuestionController@giveAnswer' );
    ...
    Route::get( '/clauseListByTolalClause', 'Backend\MasterSetup\AjaxController@clauseListByTolalClause' )->name( 'clauseListByTolalClause' );


    // Get Union, Upazila, District, Division List By Id:
    Route::get( '/unionListByUpazilaId', 'Backend\MasterSetup\AjaxController@unionListByUpazilaId' )->name( 'unionListByUpazilaId' );
    ...
    // Get Circular Data By Parliament Session Id:
    Route::get( 'circularDateBySessionId', 'Backend\MasterSetup\AjaxController@circularDateBySessionId' )->name( 'circularDateBySessionId' );
    ...
    Route::post( '/mppbook', 'Backend\ProfileActivities\MpBookController@show' );
    ...
    Route::post( '/changepassword', 'Backend\UserManagement\UserController@updatePassword' );
...
Route::group( 
    ...
    Route::get( 'orderofday', 'OrderOfDaysController@currentOrderOfDay' );
} );
