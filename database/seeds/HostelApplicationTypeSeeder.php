    ...
    public function run()
    {
        $datas = [
            [
                ...
                'name' => 'Application for new hostel allotment',
                'name_bn' => 'সংসদ সদস্য হোস্টেল বরাদ্দের জন্য আবেদন।',
                'type_name' => 'hostelAllotment',
                'created_by' => 1,
            ], [
                'id' => 2,
                'subject' => 'সংসদ সদস্য হোস্টেল বরাদ্দ বাতিলের জন্য আবেদন।',
                'name' => 'Application for cancel allotted hostel',
                'name_bn' => 'সংসদ সদস্য হোস্টেল বরাদ্দ বাতিলের জন্য আবেদন।',
                'type_name' => 'hostelCancel',
                'created_by' => 1,
            ], [
                'id' => 3,
                'subject' => 'সংসদ সদস্য হোস্টেল বরাদ্দ পরিবর্তনের জন্য আবেদন।',
                'name' => 'Application for exchange allotted hostel',
                'name_bn' => 'সংসদ সদস্য হোস্টেল বরাদ্দ পরিবর্তনের জন্য আবেদন।',
