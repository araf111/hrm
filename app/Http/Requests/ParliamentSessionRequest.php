...
class ParliamentSessionRequest extends FormRequest {
    ...
    public function rules( Request $request ) {
        return [
            ...
            'date_from'     => 'required',
            'date_to'       => 'required',
            'attachment'    => 'nullable|mimes:ppt,pptx,doc,docx,pdf,xls,xlsx,txt,jpeg,jpg,png|max:204800',
        ];
    }
    ...
    public function messages() {
        return [
            ...
            'attachment.*'       => 'Only Doc, Docx, PDF, TXT, XLS, XLSX, JPEG, JPG, PNG Files are Allowed',
        ];
    }
}
