...
class PersonalSecretaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($result){
                return redirect()->route('admin.master_setup.personal_secretaries.index')->with('success','Data Saved Successfully');
            }else{
                return redirect()->route('admin.master_setup.personal_secretaries.create')->with('error','Data Does Not Save Successfully')->withInput();
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if($result){
                return redirect()->route('admin.master_setup.personal_secretaries.index')->with('success','Data Updated Successfully');
            }else{
                return redirect()->route('admin.master_setup.personal_secretaries.create')->with('error','Data Does Not Update Successfully')->withInput();
            }
            DB::commit();
            $alert = "success";
