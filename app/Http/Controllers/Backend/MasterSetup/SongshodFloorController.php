...
class SongshodFloorController extends Controller
{
    ...
    public function create()
    {
        ...
        $title = "Create";
        return view('backend.master_setup.floor.form', compact('data', 'title','block'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $message = [
            // 'block_id.required'        => 'The block field is required',
            'name.required'        => 'The english name field is required',
            'name_bn.required'      => 'The bangla name field is required.',
        ];
